...
public class Level3Models {
    ...
    public static ComputationGraphConfiguration getModel0e(){
        ComputationGraphConfiguration config = new NeuralNetConfiguration.Builder()
                ...
                .addLayer("L6", new ConvolutionLayer.Builder(2,2)
                        ...
                        .stride(1,1).build()
                        , "L4")                
                .addLayer("L1Pool", new SubsamplingLayer.Builder(new int[]{2,2}, new int[]{2,2}).build(), "L5")
                .addLayer("L2Pool", new SubsamplingLayer.Builder(new int[]{2,2}, new int[]{2,2}).build(), "L6")
                .addLayer("dcDense", new DenseLayer.Builder().nOut(48).dropOut(0.5).build(), "L1Pool")
                .addLayer("ecDense", new DenseLayer.Builder().nOut(48).dropOut(0.5).build(), "L2Pool")
                .addVertex("merge", new MergeVertex(), "dcDense", "ecDense")
                .addLayer("out", new OutputLayer.Builder()
    ...
    public static ComputationGraphConfiguration getModel(String modelname){
        switch(modelname){
            ...
            case "0e": return Level3Models.getModel0e();
            default: return null;
        }
    }
}
